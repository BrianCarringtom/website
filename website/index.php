...
<html lang="en">
    <head>
        ...
        <title>Academia CARRINGTOM</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="assets/img/logocarringtom.png" alt="..." /></a>
            ...
            <div class="container">
                ...
                <?php foreach($lista_servicios as $registros ) { ?>
                    <div class="col-md-4">
                        ...
                        <p classtext-muted"><?php echo $registros["descripcion"];?></p>
                    </div>
                    <?php } ?>
